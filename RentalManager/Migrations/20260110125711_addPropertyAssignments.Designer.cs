...
namespace RentalManager.Migrations
{
    ...
    [Migration("20260110125711_addPropertyAssignments")]
    partial class addPropertyAssignments
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RentalManager.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2026, 1, 10, 15, 57, 7, 65, DateTimeKind.Local).AddTicks(1669),
                            IsEnabled = true,
                            Name = "SuperAdmin"
                        },
                        new
                        {
                            Id = 2,
                            CreatedOn = new DateTime(2026, 1, 10, 15, 57, 7, 65, DateTimeKind.Local).AddTicks(1690),
                            IsEnabled = true,
                            Name = "Owner"
                        },
                        new
                        {
                            Id = 3,
                            CreatedOn = new DateTime(2026, 1, 10, 15, 57, 7, 65, DateTimeKind.Local).AddTicks(1691),
                            IsEnabled = true,
                            Name = "Manager"
                        },
                        new
                        {
                            Id = 4,
                            CreatedOn = new DateTime(2026, 1, 10, 15, 57, 7, 65, DateTimeKind.Local).AddTicks(1693),
                            IsEnabled = true,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 5,
                            CreatedOn = new DateTime(2026, 1, 10, 15, 57, 7, 65, DateTimeKind.Local).AddTicks(1694),
                            IsEnabled = true,
                            Name = "Landlord"
                        },
                        new
                        {
                            Id = 6,
                            CreatedOn = new DateTime(2026, 1, 10, 15, 57, 7, 65, DateTimeKind.Local).AddTicks(1696),
                            IsEnabled = true,
                            Name = "Tenant"
                        });
                });
