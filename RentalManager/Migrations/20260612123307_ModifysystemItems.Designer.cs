...
namespace RentalManager.Migrations
{
    ...
    [Migration("20260612123307_ModifysystemItems")]
    partial class ModifysystemItems
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentalManager.Models.Booking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RentalManager.Models.Document", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RentalManager.Models.MaintenanceRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RentalManager.Models.Subscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RentalManager.Models.Booking", b =>
                {
                    ...
                    b.HasOne("RentalManager.Models.SystemCodeItem", "BookingSource")
                        .WithMany()
                        .HasForeignKey("BookingSourceId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("RentalManager.Models.SystemCodeItem", "BookingStatus")
                        .WithMany()
            ...
            modelBuilder.Entity("RentalManager.Models.Document", b =>
                {
                    ...
                    b.HasOne("RentalManager.Models.Lease", "Lease")
                        .WithMany()
            ...
            modelBuilder.Entity("RentalManager.Models.MaintenanceRequest", b =>
                {
                    ...
                    b.HasOne("RentalManager.Models.User", "AssignedToUser")
                        .WithMany()
